...
import (
	...
	pipelinev1alpha1 "github.com/ouyang-xlauncher/pipeline/pkg/apis/pipeline/v1alpha1"
	...
	v1alpha1 "github.com/ouyang-xlauncher/pipeline/pkg/client/listers/pipeline/v1alpha1"
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.TektonV1alpha1().PipelineRuns(namespace).List(context.TODO(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.TektonV1alpha1().PipelineRuns(namespace).Watch(context.TODO(), options)
			},
		},
