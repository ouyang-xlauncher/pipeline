...
func Get(ctx context.Context, selector string) v1alpha1.PipelineRunInformer {
	untyped := ctx.Value(Key{Selector: selector})
	if untyped == nil {
		logging.FromContext(ctx).Panicf(
			"Unable to fetch github.com/ouyang-xlauncher/pipeline/pkg/client/informers/externalversions/pipeline/v1alpha1.PipelineRunInformer with selector %s from context.", selector)
	}
