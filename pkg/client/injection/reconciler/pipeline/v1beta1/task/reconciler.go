...
// controller finalizing v1beta1.Task if they want to process tombstoned resources
...
type ReadOnlyFinalizer interface {
	// ObserveFinalizeKind implements custom logic to observe the final state of v1beta1.Task.
	// This method should not write to the API.
	//
	// Deprecated: Use reconciler.ObserveDeletion instead.
	ObserveFinalizeKind(ctx context.Context, o *v1beta1.Task) reconciler.Event
}
