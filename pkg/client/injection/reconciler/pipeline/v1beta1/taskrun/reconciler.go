...
func (r *reconcilerImpl) updateFinalizersFiltered(ctx context.Context, resource *v1beta1.TaskRun) (*v1beta1.TaskRun, error) {

	getter := r.Lister.TaskRuns(resource.Namespace)
