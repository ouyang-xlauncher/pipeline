...
import (
	...
	pipelineclient "github.com/ouyang-xlauncher/pipeline/pkg/client/injection/client"
	conditioninformer "github.com/ouyang-xlauncher/pipeline/pkg/client/injection/informers/pipeline/v1alpha1/condition"
	runinformer "github.com/ouyang-xlauncher/pipeline/pkg/client/injection/informers/pipeline/v1alpha1/run"
	clustertaskinformer "github.com/ouyang-xlauncher/pipeline/pkg/client/injection/informers/pipeline/v1beta1/clustertask"
	pipelineinformer "github.com/ouyang-xlauncher/pipeline/pkg/client/injection/informers/pipeline/v1beta1/pipeline"
	pipelineruninformer "github.com/ouyang-xlauncher/pipeline/pkg/client/injection/informers/pipeline/v1beta1/pipelinerun"
	taskinformer "github.com/ouyang-xlauncher/pipeline/pkg/client/injection/informers/pipeline/v1beta1/task"
	taskruninformer "github.com/ouyang-xlauncher/pipeline/pkg/client/injection/informers/pipeline/v1beta1/taskrun"
	pipelinerunreconciler "github.com/ouyang-xlauncher/pipeline/pkg/client/injection/reconciler/pipeline/v1beta1/pipelinerun"
	resourceinformer "github.com/ouyang-xlauncher/pipeline/pkg/client/resource/injection/informers/resource/v1alpha1/pipelineresource"
