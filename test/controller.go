...
import (
	...
	informersv1alpha1 "github.com/ouyang-xlauncher/pipeline/pkg/client/informers/externalversions/pipeline/v1alpha1"
	informersv1beta1 "github.com/ouyang-xlauncher/pipeline/pkg/client/informers/externalversions/pipeline/v1beta1"
	fakepipelineclient "github.com/ouyang-xlauncher/pipeline/pkg/client/injection/client/fake"
	fakeconditioninformer "github.com/ouyang-xlauncher/pipeline/pkg/client/injection/informers/pipeline/v1alpha1/condition/fake"
	fakeruninformer "github.com/ouyang-xlauncher/pipeline/pkg/client/injection/informers/pipeline/v1alpha1/run/fake"
	fakeclustertaskinformer "github.com/ouyang-xlauncher/pipeline/pkg/client/injection/informers/pipeline/v1beta1/clustertask/fake"
	fakepipelineinformer "github.com/ouyang-xlauncher/pipeline/pkg/client/injection/informers/pipeline/v1beta1/pipeline/fake"
	...
	faketaskinformer "github.com/ouyang-xlauncher/pipeline/pkg/client/injection/informers/pipeline/v1beta1/task/fake"
	faketaskruninformer "github.com/ouyang-xlauncher/pipeline/pkg/client/injection/informers/pipeline/v1beta1/taskrun/fake"
	fakeresourceclientset "github.com/ouyang-xlauncher/pipeline/pkg/client/resource/clientset/versioned/fake"
	resourceinformersv1alpha1 "github.com/ouyang-xlauncher/pipeline/pkg/client/resource/informers/externalversions/resource/v1alpha1"
	fakeresourceclient "github.com/ouyang-xlauncher/pipeline/pkg/client/resource/injection/client/fake"
	fakeresourceinformer "github.com/ouyang-xlauncher/pipeline/pkg/client/resource/injection/informers/resource/v1alpha1/pipelineresource/fake"
	cloudeventclient "github.com/ouyang-xlauncher/pipeline/pkg/reconciler/events/cloudevent"
	"go.uber.org/zap"
